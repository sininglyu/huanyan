...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    try {
      setLoading(true);
      // Logto handles both sign-in and sign-up on the same page
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          <ThemedText style={styles.title}>开启美丽之旅</ThemedText>
        ...
        <View style={styles.form}>
          ...
          <View style={[styles.inputContainer, { backgroundColor: colorScheme === 'dark' ? '#2a2a2a' : '#f8f8f8' }]}>
            ...
            />
            <TouchableOpacity>
              <ThemedText style={[styles.getCode, { color: colors.primary }]}>
                获取验证码
              </ThemedText>
            </TouchableOpacity>
          </View>
          ...
          >
            {loading ? (
              ...
              <View style={styles.buttonContent}>
                <Text style={styles.buttonText}>注册并登录</Text>
        ...
        <View style={styles.socialRow}>
          <TouchableOpacity style={[styles.socialButton, { borderColor: colors.subtitle + '30' }]} onPress={handleSignUp}>
